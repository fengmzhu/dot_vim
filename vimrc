...
"""LATEX
	...
	"autocmd FileType tex inoremap <localleader>c <Esc>:!latexdockercmd<space>pdflatex<space><c-r>%<Enter>a
	"autocmd FileType tex nnoremap <localleader>c :!latexdockercmd<space>pdflatex<space><c-r>%<Enter>
	autocmd FileType tex inoremap <localleader>c <Esc>:w!<cr>:!latexdockercmd<space>latexmk<space>-cd<space>-f<space>-interaction=batchmode<space>-pdf<space><c-r>%<cr><cr>a
	autocmd FileType tex nnoremap <localleader>c :w!<cr>:!latexdockercmd<space>latexmk<space>-cd<space>-f<space>-interaction=batchmode<space>-pdf<space><c-r>%<cr><cr>
	" Code snippets
